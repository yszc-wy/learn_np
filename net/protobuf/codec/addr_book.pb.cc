...
extern PROTOBUF_INTERNAL_EXPORT_addr_5fbook_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_Person_addr_5fbook_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_addr_5fbook_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Person_PhoneNumber_addr_5fbook_2eproto;
namespace tutorial {
...
static void InitDefaultsscc_info_AddressBook_addr_5fbook_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_AddressBook_addr_5fbook_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_AddressBook_addr_5fbook_2eproto}, {
      &scc_info_Person_addr_5fbook_2eproto.base,}};

static void InitDefaultsscc_info_Person_addr_5fbook_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_Person_addr_5fbook_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_Person_addr_5fbook_2eproto}, {
      &scc_info_Person_PhoneNumber_addr_5fbook_2eproto.base,}};

static void InitDefaultsscc_info_Person_PhoneNumber_addr_5fbook_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Person_PhoneNumber_addr_5fbook_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_Person_PhoneNumber_addr_5fbook_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_addr_5fbook_2eproto[3];
static const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* file_level_enum_descriptors_addr_5fbook_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_addr_5fbook_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_addr_5fbook_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
...
const char descriptor_table_protodef_addr_5fbook_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\017addr_book.proto\022\010tutorial\"\333\001\n\006Person\022\014"
  ...
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_addr_5fbook_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_addr_5fbook_2eproto_sccs[3] = {
  &scc_info_AddressBook_addr_5fbook_2eproto.base,
  &scc_info_Person_addr_5fbook_2eproto.base,
  &scc_info_Person_PhoneNumber_addr_5fbook_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_addr_5fbook_2eproto_once;
static bool descriptor_table_addr_5fbook_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_addr_5fbook_2eproto = {
  &descriptor_table_addr_5fbook_2eproto_initialized, descriptor_table_protodef_addr_5fbook_2eproto, "addr_book.proto", 298,
  &descriptor_table_addr_5fbook_2eproto_once, descriptor_table_addr_5fbook_2eproto_sccs, descriptor_table_addr_5fbook_2eproto_deps, 3, 0,
  schemas, file_default_instances, TableStruct_addr_5fbook_2eproto::offsets,
  file_level_metadata_addr_5fbook_2eproto, 3, file_level_enum_descriptors_addr_5fbook_2eproto, file_level_service_descriptors_addr_5fbook_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_addr_5fbook_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_addr_5fbook_2eproto), true);
namespace tutorial {
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* Person_PhoneType_descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_addr_5fbook_2eproto);
  return file_level_enum_descriptors_addr_5fbook_2eproto[0];
}
...
void Person_PhoneNumber::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_Person_PhoneNumber_addr_5fbook_2eproto.base);
  number_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  type_ = 1;
}
...
void Person::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_Person_addr_5fbook_2eproto.base);
  name_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  email_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  id_ = 0;
}
...
void AddressBook::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_AddressBook_addr_5fbook_2eproto.base);
}
